...
const float SEALEVEL = -4; // Zeewolde
const float SEALEVEL_PRESSURE = 1013.25;


#define DIGITAL_INPUT_SENSOR 19   // The digital input you attached your motion sensor.
#define INTERRUPT 2 // Usually the interrupt = pin -2 (on uno/nano anyway, on mega d19 = int 2
#define MOTION_CHILD 2   // Id of the senso child
...
unsigned long SLEEP_TIME1 = 60000; // 1 minute required for forecast algorithm
unsigned long SLEEP_TIME2 = 60000; // 1 minute required for forecast algorithm
...
{
	gw.begin();
	gw.sendSketchInfo("Weather Motion Sensor", "3.1");
...
void loop() 
{
  ...
  // Sleep until interrupt comes in on motion sensor. Send update every two minute. 
	gw.sleep(INTERRUPT,CHANGE, SLEEP_TIME1);
