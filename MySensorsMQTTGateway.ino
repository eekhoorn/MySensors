...
IPAddress TCP_IP ( 10, 38, 92, 40 );				// Configure your static ip-address here
byte TCP_MAC[] = { 0xDE, 0xDE, 0xAD, 0xAD, 0x00, 0x42 };	// Mac-address - You should change this! see note *2 above!
